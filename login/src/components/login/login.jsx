                    ...
                    <div className="row g-0 min-vh-100">
                        <div className="col-md-4">
                            <div className="hero-wrap d-flex align-items-center h-100">
                                ...
                                <div className="hero-bg hero-bg-scroll" style={{ backgroundImage: 'url("./images/login-bg-6.jpg")' }} />
                                <div className="hero-content mx-auto w-100 h-100">
                                    <div className="container d-flex flex-column h-100">
                                        <div className="row g-0">
                                            <div className="col-11 col-lg-9 mx-auto">
                                                <div className="logo mt-5 mb-5"> <a className="d-flex" href="index.html" title="Oxyy"><img src="images/logo-2-light.png" alt="Oxyy" /></a> </div>
                                            </div>
                                        </div>
                                ...
                                <div className="row g-0">
                                    <div className="col-11 col-md-8 col-lg-7 col-xl-6 mx-auto">
                                        ...
                                        <div className="d-flex">
                                            <button type="button" className="btn btn-primary btn-sm fw-400 rounded-3 shadow-none"><span className="me-2"><i className="fab fa-google" /></span><span className="mx-3">Log in with Google</span></button>
                                            <ul className="social-icons d-inline-block social-icons-rounded">
                                                <li className="social-icons-apple mb-0"><a className="bg-dark-4" href="#" data-bs-toggle="tooltip" data-bs-original-title="Sign in with apple"><i className="fab fa-apple" /></a></li>
                                            </ul>
                                        </div>
